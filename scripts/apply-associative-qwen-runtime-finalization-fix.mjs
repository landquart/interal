...
await replaceSection(
  ...
  'function modelForGeneratedCandidate',
  ''
);
...
assert.deepEqual(
  finalized.slice(0, 5).map(candidate => candidate.word),
  ['altruism', 'altruist', 'alteration', 'alterity', 'alternate'],
  'supplemental winners are moved into the visible top five in final-P order'
);
