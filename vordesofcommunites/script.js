...
const I18N = {
  ru: { title:'Vordes of communités', lead:'Проверка слов профессиональных, культурных, субкультурных, юридических, технических и других сообществ.', params:'1) Параметры слова', word:'Слово в Интерaле', pos:'Часть речи', domain:'Область / сообщество', translations:'2) Переводы', criteria:'3) Критерии', result:'4) Итог', card:'5) JSON-карточка', adverb:'наречие', noun:'существительное', adjective:'прилагательное', expression:'выражение', check:'Проверить', example:'Пример', qwen:'Qwen-анализ', json:'Сформировать JSON', copy:'Скопировать', download:'Скачать', passed:'Пройдено', decision:'Решение', accept:'ПРИНЯТЬ', reject:'НЕ ПРИНИМАТЬ', qwenUnavailable:'Qwen endpoint не найден. Критерии можно заполнить вручную.', table:{language:'Язык', translation:'Перевод'}, answer:'Ответ', passes:'Проходит' },
  en: { title:'Vordes of communités', lead:'Check professional, cultural, subcultural, legal, technical and other community-specific words.', params:'1) Word parameters', word:'Interal word', pos:'Part of speech', domain:'Domain / community', translations:'2) Translations', criteria:'3) Criteria', result:'4) Result', card:'5) JSON card', adverb:'adverb', noun:'noun', adjective:'adjective', expression:'expression', check:'Check', example:'Example', qwen:'Qwen analysis', json:'Generate JSON', copy:'Copy', download:'Download', passed:'Passed', decision:'Decision', accept:'ACCEPT', reject:'DO NOT ACCEPT', qwenUnavailable:'Qwen endpoint not found. Criteria can be edited manually.', table:{language:'Language', translation:'Translation'}, answer:'Answer', passes:'Passes' }
};
