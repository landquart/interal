(function () {
  ...
  const canCopyPageState = /\/(indoeuropanvordes|associativvordes|determinatorofvalentyp|internationalismes|vordesofcommunites|grammaticebrevivordes|grammaticebrevvordes)\//.test(window.location.pathname);
