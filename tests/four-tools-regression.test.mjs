...
const { calculateFinalScore } = await import('../associativvordes/js/association-analyzer.js');
assert.equal(calculateFinalScore({association_score:null,frequency_score:100}),null);
assert.equal(calculateFinalScore({association_score:100,frequency_score:null}),null);
