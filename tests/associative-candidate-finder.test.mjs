...
assert.deepEqual(words(findCandidatesForRoot({ entries: [entry('alter-null', 'alternull', { rank: null }), entry('alter-ranked', 'alterranked', { rank: 3 })], root: 'alter' })), ['alter-ranked', 'alter-null'], 'rank influences sorting after match quality, frequency and IPM tie');
assert.deepEqual(words(findCandidatesForRoot({ entries: [entry('alter-null-high-frequency', 'alternullhighfrequency', { rank: null, frequency_score: 90 }), entry('alter-ranked-low-frequency', 'alterrankedlowfrequency', { rank: 1, frequency_score: 10 })], root: 'alter' })), ['alter-null-high-frequency', 'alter-ranked-low-frequency'], 'frequency_score is compared before real rank vs null');
assert.deepEqual(words(findCandidatesForRoot({ entries: [entry('alter-null-high-ipm', 'alternullhighipm', { rank: null, frequency_score: 50, ipm: 90 }), entry('alter-ranked-low-ipm', 'alterrankedlowipm', { rank: 1, frequency_score: 50, ipm: 1 })], root: 'alter' })), ['alter-null-high-ipm', 'alter-ranked-low-ipm'], 'IPM is compared before real rank vs null');
