...
assert.deepEqual(words(findCandidatesForRoot({ entries: [entry('alter-null', 'alter-null', { rank: null }), entry('alter-ranked', 'alter-ranked', { rank: 3 })], root: 'alter' })), ['alter-ranked', 'alter-null'], 'rank influences sorting after match quality, frequency and IPM tie');
...
assert.deepEqual(words(findCandidatesForRoot({ entries: [entry('alter-null-high-ipm', 'alter-null-high-ipm', { rank: null, frequency_score: 50, ipm: 90 }), entry('alter-ranked-low-ipm', 'alter-ranked-low-ipm', { rank: 1, frequency_score: 50, ipm: 1 })], root: 'alter' })), ['alter-null-high-ipm', 'alter-ranked-low-ipm'], 'IPM is compared before real rank vs null');
