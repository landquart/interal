...
const TEXT_I18N = {
    ...
    function createRunDiagnostics() {
      return {
        ...
        candidateAuditValidatedLanguageCount: 0,
        candidateAuditValidationIncompleteLanguageCount: 0,
        candidateAuditValidationKeptCount: 0,
        candidateAuditValidationRemovedDuplicateCount: 0,
        candidateAuditValidationRemovedIrrelevantCount: 0,
    ...
    function cloneSnapshot() {
      ...
      return JSON.parse(JSON.stringify({
        ...
        candidateIds: index.candidateIds || 0,
        exactCandidateIds: index.exactCandidateIds || 0,
        fuzzyCandidateIds: index.fuzzyCandidateIds || 0,
        candidateEntryBlocks: index.candidateEntryBlocks || 0,
        querySuppressed: index.querySuppressed === true,
        querySuppressedReason: index.querySuppressedReason || null,
        ...
        candidateAuditValidatedLanguageCount: run.candidateAuditValidatedLanguageCount,
        candidateAuditValidationIncompleteLanguageCount: run.candidateAuditValidationIncompleteLanguageCount,
        candidateAuditValidationKeptCount: run.candidateAuditValidationKeptCount,
        candidateAuditValidationRemovedDuplicateCount: run.candidateAuditValidationRemovedDuplicateCount,
        candidateAuditValidationRemovedIrrelevantCount: run.candidateAuditValidationRemovedIrrelevantCount,
