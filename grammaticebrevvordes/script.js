...
const I18N = {
  ru: { title:'Grammatic e brev vordes', lead:'', params:'Параметры слова', word:'Слово в Интерaле', pos:'Часть речи', meaning:'Значение / функция', translations:'Переводы', criteria:'Системные критерии', arguments:'Аргументы человека', result:'Итог', card:'JSON-карточка', preposition:'предлог', conjunction:'союз', particle:'частица', adverb:'наречие', check:'Проверить', example:'Пример', qwen:'Qwen-анализ', json:'Сформировать JSON-карточку', copy:'Скопировать', download:'Скачать', passed:'Пройдено', decision:'Решение', accept:'ПРИНЯТО', reject:'НЕ ПРИНЯТО', qwenUnavailable:'Qwen endpoint не найден. Критерии можно заполнить вручную.', table:{language:'Язык', translation:'Перевод'}, comment:'Комментарий' },
  en: { title:'Grammatic e brev vordes', lead:'', params:'Word parameters', word:'Interal word', pos:'Part of speech', meaning:'Meaning / function', translations:'Translations', criteria:'Systemic criteria', arguments:'Human arguments', result:'Decision', card:'JSON card', preposition:'preposition', conjunction:'conjunction', particle:'particle', adverb:'adverb', check:'Check', example:'Example', qwen:'Qwen analysis', json:'Сформировать JSON-карточку', copy:'Copy', download:'Download', passed:'Passed', decision:'Decision', accept:'ACCEPTED', reject:'NOT ACCEPTED', qwenUnavailable:'Qwen endpoint not found. Criteria can be edited manually.', table:{language:'Language', translation:'Translation'}, comment:'Comment' }
};
