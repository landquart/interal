...
const I18N = {
  ru: { title:'Grammatic e brev vordes', lead:'Оформление грамматических и кратких слов через значение, аргументы и системные критерии.', params:'1) Параметры слова', word:'Слово в Интерaле', pos:'Часть речи', meaning:'Значение / функция', translations:'2) Переводы', criteria:'3) Системные критерии', arguments:'Аргументы человека', result:'4) Итог', card:'5) JSON-карточка', preposition:'предлог', conjunction:'союз', particle:'частица', adverb:'наречие', check:'Проверить', example:'Пример', qwen:'Qwen-анализ', json:'Сформировать JSON', copy:'Скопировать', download:'Скачать', passed:'Пройдено', decision:'Решение', accept:'ПРИНЯТЬ', reject:'НЕ ПРИНИМАТЬ', qwenUnavailable:'Qwen endpoint не найден. Критерии можно заполнить вручную.', table:{language:'Язык', translation:'Перевод'}, comment:'Комментарий' },
  en: { title:'Grammatic e brev vordes', lead:'Create grammar and short-word cards through meaning, arguments and systemic criteria.', params:'1) Word parameters', word:'Interal word', pos:'Part of speech', meaning:'Meaning / function', translations:'2) Translations', criteria:'3) Systemic criteria', arguments:'Human arguments', result:'4) Result', card:'5) JSON card', preposition:'preposition', conjunction:'conjunction', particle:'particle', adverb:'adverb', check:'Check', example:'Example', qwen:'Qwen analysis', json:'Generate JSON', copy:'Copy', download:'Download', passed:'Passed', decision:'Decision', accept:'ACCEPT', reject:'DO NOT ACCEPT', qwenUnavailable:'Qwen endpoint not found. Criteria can be edited manually.', table:{language:'Language', translation:'Translation'}, comment:'Comment' }
};
